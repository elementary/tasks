...
public class Tasks.TaskRow : Gtk.ListBoxRow {
    ...
    private Tasks.LocationPopover location_popover = new Tasks.LocationPopover () {
        placeholder = _("Set Location"),
        image = new Gtk.Image.from_icon_name ("location-inactive-symbolic", Gtk.IconSize.BUTTON)
    };
