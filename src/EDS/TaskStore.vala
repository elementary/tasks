...
errordomain EDS.TaskStoreError {
    CLIENT_NOT_AVAILABLE
}


public class EDS.TaskStore : Object {
    ...
    private ECal.Client get_client (E.Source task_list) throws Error {
        ...
        if (client == null) {
            throw new EDS.TaskStoreError.CLIENT_NOT_AVAILABLE ("No client available for task list '%s'".printf (task_list.dup_display_name ()));  // vala-lint=line-length
        }
    ...
    private void on_objects_added (E.Source task_list, ECal.Client client, SList<ICal.Component> objects, TasksAddedFunc on_tasks_added) {  // vala-lint=line-length
        ...
        var added_tasks = new Gee.ArrayList<ECal.Component> ((Gee.EqualDataFunc<ECal.Component>?) EDS.ecalcomponent_equal_func);  // vala-lint=line-length
    ...
    private void on_objects_modified (E.Source task_list, ECal.Client client, SList<ICal.Component> objects, TasksModifiedFunc on_tasks_modified) {  // vala-lint=line-length
        ...
        var updated_tasks = new Gee.ArrayList<ECal.Component> ((Gee.EqualDataFunc<ECal.Component>?) EDS.ecalcomponent_equal_func);  // vala-lint=line-length
